    ...
    render() {
      ...
      return (
        <div>
          ...
          {
            (video || mutilVideo) ? <div className="open-newsapp-tip" onClick={this.openNewsapp}>打开网易新闻，参与直播体验更加流畅</div> : null
          }
        </div>
      )
    }
    ...
    render() {
      return (
        <footer className={'g-footer' + (this.props.isFull ? ' full-video' : '')}>
          ...
          <div className="open-newsapp" onClick={this.openNewsapp}>立即打开&gt;</div>
